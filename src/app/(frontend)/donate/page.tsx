        ...
        <div ref={pageRef} className="bg-transparent min-h-screen">
            ...
            <section className="relative md:h-dvh md:min-h-[600px] flex flex-col justify-end overflow-hidden pt-12 md:pt-0">
                <div
                    ...
                    style={{
                        backgroundImage: `url('/hero/donate-hero-compelling.webp')`,
                    }}
                />
                                ...
                                {[
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 flex min-w-0 outline-none focus:outline-none items-center justify-start sm:justify-center gap-3 sm:gap-2 lg:gap-3 py-4 px-6 sm:px-3 lg:px-6 rounded-xl sm:rounded-full font-bold text-xs sm:text-[10px] lg:text-xs xl:text-sm uppercase tracking-wider transition-all duration-300 font-mono whitespace-nowrap min-h-[48px] overflow-hidden ${
                                                isActive
